...
class QueuedTorrents(component.Component):
    def __init__(self):
        ...
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'queuedtorrents.ui'),
        ))
        ...
        self.treeview.append_column(Gtk.TreeViewColumn(_('Torrent'), Gtk.CellRendererText(), text=0))
    ...
    def update_status_bar(self):
        ...
        try:
            ...
            # update it later.
            GLib.timeout_add(100, self.update_status_bar)
            return False
