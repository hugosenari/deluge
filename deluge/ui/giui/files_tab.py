...
from .common import (listview_replace_treestore, load_pickled_state_file, reparent_iter,
...
class FilesTab(Tab):
    def __init__(self):
        ...
        self.listview.enable_model_drag_source(
            Gdk.ModifierType.BUTTON1_MASK, [('text/plain', 0, 0)], Gdk.DragAction.DEFAULT | Gdk.DragAction.MOVE,
        )
