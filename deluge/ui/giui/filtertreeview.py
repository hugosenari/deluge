...
class FilterTreeView(component.Component):
    def __init__(self):
        ...
        context = component.get('MainWindow').window.get_style_context()
        self.colour_background = context.get_background_color(Gtk.StateFlags.NORMAL)
        self.colour_foreground = context.get_color(Gtk.StateFlags.NORMAL)

        # filtertree menu
        builder = Gtk.Builder()
        builder.add_from_file(resource_filename('deluge.ui.giui', os.path.join('glade', 'filtertree_menu.ui')))
