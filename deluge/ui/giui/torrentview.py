...
try:
    CTRL_ALT_MASK = Gdk.ModifierType.CONTROL_MASK | Gdk.ModifierType.MOD1_MASK
except TypeError:
...
class TorrentView(ListView, component.Component):
    ...
    def __init__(self):
        ...
        self.add_func_column(
            _('Remaining'), funcs.cell_data_size, [GObject.TYPE_UINT64],
    ...
    def update(self, select_row=False):
        ...
        if self.got_state:
            ...
            GLib.idle_add(self.send_status_request, None, select_row)
