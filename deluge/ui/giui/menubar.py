...
class MenuBar(component.Component):
    ...
    def __init__(self):
        ...
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'torrent_menu.ui'),
        ))
        # Get the torrent options menu from the gtk builder file
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'torrent_menu.options.ui'),
        ))
        # Get the torrent queue menu from the gtk builder file
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'torrent_menu.queue.ui'),
        ))
    ...
    def show_move_storage_dialog(self, status):
        ...
        builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'move_storage_dialog.ui'),
        ))
        # Keep it referenced:
