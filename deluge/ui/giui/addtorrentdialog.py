...
class AddTorrentDialog(component.Component):
    def __init__(self):
        ...
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'add_torrent_dialog.ui'),
        ))
        # The infohash dialog
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'add_torrent_dialog.infohash.ui'),
        ))
        # The url dialog
        self.builder.add_from_file(deluge.common.resource_filename(
            'deluge.ui.giui', os.path.join('glade', 'add_torrent_dialog.url.ui'),
        ))
